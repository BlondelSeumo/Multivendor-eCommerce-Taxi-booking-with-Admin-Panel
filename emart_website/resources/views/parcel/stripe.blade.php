                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input name="cardholder-name" required type="text"
                                                               placeholder="{{trans('lang.card_holder')}}" class="form-control"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input name="address_line1" id="address_line1" required
                                                               type="text" placeholder="{{trans('lang.address_line1_error')}}"
                                                               class="form-control"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input name="address_line2" id="address_line2" required
                                                               type="text" placeholder="{{trans('lang.landmark')}}" class="form-control"
                                                               value="<?php echo $cart_order['senderAddress']; ?>"/>
                                                    </div>
                                                </div>
