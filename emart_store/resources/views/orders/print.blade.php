        ...
        function buildHTMLProductstotal(snapshotsProducts) {
            ...
            if (!isNaN(tax) && tax != 0) {
                if (currencyAtRight) {
                    ...
                    $('.total_tax_amount').text("+ " + parseFloat(tax).toFixed(2) + " " + currentCurrency + ' (' + taxlabel + ' ' + snapshotsProducts.taxSetting.tax + ' ' + taxlabeltype + ')');
                } else {
                    ...
                    $('.total_tax_amount').text("+ " + currentCurrency + "" + parseFloat(tax).toFixed(2) + '(' + taxlabel + ' ' + snapshotsProducts.taxSetting.tax + ' ' + taxlabeltype + ')');
                }
