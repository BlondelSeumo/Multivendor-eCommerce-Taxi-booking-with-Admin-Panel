			...
			<div class="card-body">
				...
				<div class="row business-analytics_list">
					...
					<div class="col-sm-6 col-lg-3">
						<a class="order-status pending" href="{!! route('rental_orders') !!}">
						<div class="data">
					...
					<div class="col-sm-6 col-lg-3">
						<a class="order-status confirmed" href="{!! route('rental_orders') !!}">
						<div class="data">
					...
					<div class="col-sm-6 col-lg-3">
						<a class="order-status packaging" href="{!! route('rental_orders') !!}">
						<div class="data">
					...
					<div class="col-sm-6 col-lg-3">
						<a class="order-status delivered" href="{!! route('rental_orders') !!}">	
							<div class="data">
					...
					<div class="col-sm-6 col-lg-3">
						<a class="order-status canceled" href="{!! route('rental_orders') !!}">	
							<div class="data">
					...
					<div class="col-sm-6 col-lg-3">
						<a class="order-status failed" href="{!! route('rental_orders') !!}">	
							<div class="data">
