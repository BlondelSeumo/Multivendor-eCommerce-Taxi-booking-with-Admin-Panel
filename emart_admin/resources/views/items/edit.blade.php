...
<script>
    ...
    $(document).ready(function () {
        ...
        ref.get().then(async function (snapshots) {
            ...
            //   $(".item_image").append('<img class="rounded" style="width:50px" src="'+placeholderImage+'" alt="image">');
            // }
            ...
            if (product.hasOwnProperty('product_specification')) {
                // product.product_specification.forEach((element, index) => {
                //
                //     for (var key in element) {
                //         $(".product_specification").append('<div class="row" style="margin-top:5px;" id="add_product_specification_iteam_' + index + '">' +
                //             '<div class="col-5"><input class="form-control" type="text" value="' + key + '" disabled ></div>' +
                //             '<div class="col-5"><input class="form-control" type="text" value="' + element[key] + '" disabled ></div>' +
                //             '<div class="col-2"><button class="btn" type="button" onclick="deleteProductSpecificationSingle(' + index + ')"><span class="fa fa-trash"></span></button></div></div>');
                //
                //     }
                // });
