                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                                    <li class="nav-item">
                                      <a class="nav-link active" href="{!! route('settings.vehicleType') !!}"><i class="fa fa-list mr-2"></i>{{trans('lang.vehicle_type')}}</a>
                                    </li>
                                    <li class="nav-item">
                                      <a class="nav-link" href="{!! route('settings.vehicleType.create') !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.add_vehicle_type')}}</a>
                                    </li>
                                </ul>
                            </div>
   ...
   function buildHTML(snapshots){
        ...
        alldata.forEach((listval) => {
            ...
            var val=listval;
                ...
                newdate='';
                var id = val.id;
                var route1 =  '{{route("settings.vehicleType.edit",":id")}}';
