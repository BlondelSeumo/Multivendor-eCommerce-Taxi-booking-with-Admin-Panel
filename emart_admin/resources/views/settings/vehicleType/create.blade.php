...
$(".create_user_btn").click(function(){
		...
		if(name == ''){
			...
			database.collection('vehicle_type').doc(id).set({'id':id, 'name':name, 'capacity':capacity,'short_description':short_description,'description':description, 'supported_vehicle':supported_vehicle, 'vehicle_icon':photo, 'isActive':active,
