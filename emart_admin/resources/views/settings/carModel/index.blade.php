                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                            <li class="nav-item">
                                <a class="nav-link active" href="{!! route('settings.carModel') !!}"><i
                                            class="fa fa-list mr-2"></i>{{trans('lang.car_model')}}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{!! route('settings.carModel.create') !!}"><i
...
<script type="text/javascript">
    ...
    function buildHTML(snapshots) {
        ...
        alldata.forEach((listval) => {
            ...
            newdate = '';
            var id = val.id;
            var route1 = '{{route("settings.carModel.edit",":id")}}';
            route1 = route1.replace(':id', id);

            var route2 = '{{route("settings.carMake.edit",":id")}}';
            route2 = route2.replace(':id', val.car_make_id);

            //var carMakeName = getCarMakeName(val.car_make_id);
